      ...
      if (this.customer.name != '' && this.customer.phone != '' && this.customer.address != '') {
        this.$swal({
          ...
          if (result.value) {
            ...
            axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/checkout', _this6.customer).then(function (response) {
              ...
              setTimeout(function () {
                ...
                _this6.$swal(response.data.status, _this6.message, _this6.status == 'success' ? 'success' : 'error');
              }, 1000);
            })["catch"](function (error) {
              console.log(error);
            });
...
/***/ 1:
/*!********************************************!*\
  !*** multi ./resources/assets/js/order.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\klikncleanPOS\resources\assets\js\order.js */"./resources/assets/js/order.js");
